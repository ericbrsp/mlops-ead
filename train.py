...
# os.environ['MLFLOW_TRACKING_USERNAME'] = 'eric.cadastro'
# os.environ['MLFLOW_TRACKING_PASSWORD'] = '3fd354f91a2b97f454a17405b16b201d6592d2a8'
# mlflow.set_tracking_uri('https://dagshub.com/eric.cadastro/puc-ia.mlflow')
...
if __name__ == "__main__":
    X, y = read_data()
    X_train, X_test, y_train, y_test = proccess_data(X, y)
